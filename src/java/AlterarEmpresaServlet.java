 ...
 * @author Wesley
 */
@WebServlet(urlPatterns = {"/AlterarEmpresaServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("login") != null && session.getAttribute("nome") != null) {
            ...
            if (empresaDao.update(empresa)) {
                out.println("<body><h2>Empresa " + (String) request.getParameter("razao_social") + " alterada com sucesso.</h2>");
            } else {
                out.println("<body><h2>Não foi possível alterar a empresa " + (String) request.getParameter("razao_social") + ".</h2>");
            }
